var Godot = (() => {
    ...
    return async function (moduleArg = {}) {
        ...
        var IDBFS = {
            dbs: {}, indexedDB: () => indexedDB, DB_VERSION: 21, DB_STORE_NAME: "FILE_DATA", queuePersist: mount => {
        ...
        function _godot_audio_sample_register_stream(streamObjectIdStrPtr, framesPtr, framesTotal, loopModeStrPtr, loopBegin, loopEnd) {
            ...
            GodotAudio.Sample.create({id: streamObjectId, audioBuffer}, {
                loopBegin,
                loopEnd,
                loopMode,
                numberOfChannels,
        ...
        var GodotInput = {
            inputKeyCallback: null, setInputKeyData: null, getModifiers: function (evt) {
                return evt.shiftKey + 0 + (evt.altKey + 0 << 1) + (evt.ctrlKey + 0 << 2) + (evt.metaKey + 0 << 3)
        ...
        function _godot_js_rtc_pc_remote_description_set(p_id, p_type, p_sdp, p_obj, p_session_created, p_on_error) {
            ...
            ref.setRemoteDescription({sdp, type}).then(function () {
                if (type !== "offer") {
                    return Promise.resolve()
                }
        ...
        Module["cwrap"] = cwrap;
        var _free, __Z14godot_web_mainiPPc, _main, _malloc, _fflush, __emwebxr_on_input_event,
            __emwebxr_on_simple_event, ___funcs_on_exit, _emscripten_builtin_memalign, __emscripten_timeout,
            __emscripten_stack_restore, __emscripten_stack_alloc, _emscripten_stack_get_current, memory,
